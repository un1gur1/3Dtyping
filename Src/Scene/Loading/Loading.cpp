...
void Loading::Draw(void)
{
	...
	DrawString(50, 800, "このゲームは、コマンドをtypingして、回避や移動、攻撃、必殺、などを繰り出しボスを倒すのが目的です\nコマンドは、みぎ、ひだり、うえ、した、みぎにいどう、などいろいろあるのでプレイしながら探してください\n攻撃コマンドもこうげき、はっしゃなど複数コマンドがあります", GetColor(255, 255, 255));
	DrawString(1500, 100, "LOADING" ,GetColor(255, 255, 255));
}
